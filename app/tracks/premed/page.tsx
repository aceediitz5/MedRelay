...
const contentTypes = [
  {
    ...
    title: "Flashcards",
    count: "Coming Soon",
    description: "Foundational sciences with spaced repetition",
  ...
  },
  {
    ...
    count: "Coming Soon",
    description: "MCAT‑style passages and discrete questions",
  ...
  },
  {
    ...
    count: "Coming Soon",
    description: "Clinical reasoning scenarios for pre‑meds",
    ...
    <div className="min-h-screen bg-[#080c10]">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="w-full max-w-6xl mx-auto text-center relative px-4 sm:px-8">
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed text-pretty">
            We’re building MCAT foundations, science content, and clinical reasoning practice.
          </p>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Complete Pre‑Med Learning System</h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">Launching soon with MCAT‑focused prep.</p>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Pre‑Med Curriculum Topics</h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">Planned coverage for core sciences.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {topics.map((topic) => (
              <div key={topic.name} className="group relative bg-white/[0.02] border border-white/5 rounded-xl p-5 hover:border-cyan-500/30 hover:bg-cyan-500/5 transition-all duration-300">
